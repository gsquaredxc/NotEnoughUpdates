...
public class CustomItems {
    ...
    public static final IItem NULLZEE = ItemFactory.generateItem(create(
            "NULLZEE",
            "dirt",
    ...
    public static final IItem DUCTTAPE = ItemFactory.generateItem(create(
            "DUCTTAPE",
            "iron_shovel",
    ...
    public static final IItem SPINAXX = ItemFactory.generateItem(create(
            "SPINAXX",
            "emerald",
            "Spinaxx",
            "Famous streamer btw :)"));
    public static final IItem RUNE = ItemFactory.generateItem(create("RUNE", "paper", "No.", "I hate runes."));
    public static final IItem TWOBEETWOTEE = ItemFactory.generateItem(create("2B2T", "bedrock", "Minecraft's oldest anarchy Minecraft server in Minecraft.",
    ...
    public static final IItem LEOCTHL = ItemFactory.generateItem(create("LEOCTHL", "dragon_egg", "--- Stats below may not be entirely accurate ---",
